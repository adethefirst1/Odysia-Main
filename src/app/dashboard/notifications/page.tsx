export default function NotificationsPage() {
  // Responsive scaffold for expert notifications
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto">
      ...
      <div className="space-y-3 sm:space-y-4">
        ...
        {[1, 2, 3].map((id) => (
          <div
            key={id}
            className="p-3 sm:p-4 rounded-lg bg-gray-50 dark:bg-dark-surface border border-gray-200 dark:border-gray-700"
          >
